...
const { getProjectInfos, addProject, updateProject, deleteProject, addProjectAlbum, addProjectImage, addProjectAudios, getMyProjects } = require("../controllers/project.controllers");
...
router.get("/all-projects", getProjectInfos);
